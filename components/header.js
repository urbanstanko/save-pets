  ...
  return (
    <div className='flex flex-row justify-between w-full'>
      ...
      <div className='flex flex-row items-center justify-center'>
        ...
        <HeaderLink linkName='getSavePets' name="GetSavePets"
        selected={current_page_name}/>
        <HeaderLink linkName='donations' name="Donations"
        selected={current_page_name}/>
        <HeaderLink linkName='howToBuy' name="How to buy"
        selected={current_page_name}/>
        <HeaderLink linkName='aboutUs' name="About us"
        selected={current_page_name}/>
        <HeaderLink linkName='contactUs' name="Contact us"
        selected={current_page_name}/>
